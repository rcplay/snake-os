#ifndef __CNS21XX_NIC_H__
#define __CNS21XX_NIC_H__

// the phy addr of VSC8601 && internal phy
#define CNS21XX_NIC_PHY_ADDR		0

#define CNS21XX_NIC_MAX_TFD_NUM		16
#define CNS21XX_NIC_MAX_RFD_NUM		16
...
struct cns21xx_nic_priv_t
{
	TX_DESC_T		*tx_desc_pool_dma;
	RX_DESC_T		*rx_desc_pool_dma;

	pkt_t			*tx_ring_pkt[CNS21XX_NIC_MAX_TFD_NUM];
	pkt_t			*rx_ring_pkt[CNS21XX_NIC_MAX_TFD_NUM];
